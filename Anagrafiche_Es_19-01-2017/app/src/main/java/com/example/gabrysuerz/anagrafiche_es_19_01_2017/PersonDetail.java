...
public class PersonDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mID = getIntent().getExtras().getLong(PersonHelper._ID);

        mCursor = getContentResolver().query(Uri.parse(PersonContentProvider.PERSON_URI + "/" + mID), null, null, null, null, null);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_modify) {
            ...
            getContentResolver().delete(Uri.parse(PersonContentProvider.PERSON_URI + "/" + mID), null, null);
